from kh2fmbr.KH2.KingdomHearts2 import KingdomHearts2
from kh2fmbr.textutils import create_spoiler_text
import time, json, random, os, shutil, yaml, base64, sys
from zipfile import ZipFile
import random
from kh2fmbr._config import *
from kh2fmbr.randutils import log_output
...
class Randomizer:
    ...
    def generate_mod(self, game, fn, randomization, newname=None, dumpspoilers=True):
        ...
        assets = game.generate_files(moddir, randomization, spoilers=game.spoilers)
        if dumpspoilers:
    ...
    def generateToZip(self, g, options, modobj, outZip):
        ...
        assets = game.generate_files(randomization=randomization, outzip=outZip, spoilers=game.spoilers)
...
if __name__ == '__main__':
    ...
    # run randomizer.py devgenerate "{\"boss\": \"One to One\", \"data_bosses\": true, \"enemy\": \"One to One\", \"memory_expansion\": true}"
    ...
    # run randomizer.py devgenerate "{\"selected_boss\": \"Tifa\", \"memory_expansion\": true}"
