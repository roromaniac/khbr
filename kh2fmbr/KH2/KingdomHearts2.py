from kh2fmbr.KH2.AssetGenerator import AssetGenerator
from kh2fmbr.KH2.CutsceneRemover import CutsceneRemover
from kh2fmbr.KH2.ModWriter import ModWriter
from kh2fmbr.KH2.schemas.enemyseed import EnemySeed
from kh2fmbr.textutils import create_spoiler_text
from kh2fmbr._config import DIAGNOSTICS
from kh2fmbr.randutils import pickbossmapping, pickenemymapping, log_output, read_override
from kh2fmbr.KH2.EnemyManager import EnemyManager
from kh2fmbr.KH2.LocationManager import LocationManager
from kh2fmbr.KH2.MissionManager import MissionManager
from kh2fmbr.KH2.SpawnManager import SpawnManager
from kh2fmbr.KH2.schemas.random_config import RandomConfig
import kh2fmbr
import os, time
                    ...
                    for sp, spawnpoint in room["spawnpoints"].items():
                        ...
                        for aimod in spawnpoint.get("aimods",[]):
                            if aimod["type"] == "enemymod":
                                for m in set(o["model"] for o in created_enemies if o.get("model")):
