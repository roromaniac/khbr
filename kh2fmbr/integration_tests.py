...
from kh2fmbr.randomizer import Randomizer, KingdomHearts2
from kh2fmbr.KH2.ModWriter import ModWriter
from kh2fmbr.randutils import pickbossmapping
import testutils
import shutil
...
class Tests(unittest.TestCase):
    ...
    def test_is_replacement_blocked(self):
        kh2 = KingdomHearts2()
        from kh2fmbr.KH2.schemas.enemy_records import get_schema
        source = get_schema()
